    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-black to-purple-900 text-white">
      <header className="flex justify-between items-center w-11/12 mx-auto p-[0.8px] rounded-full sticky top-0 z-50 bg-black/30 backdrop-blur-md bg-gradient-to-r from-blue-500 to-purple-500">
        <span className="flex justify-between items-center w-full bg-gray-900 text-white rounded-full pr-2 pl-8 py-2">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="bg-purple-800 font-bold text-white px-6 py-2 rounded-full hover:bg-purple-600 transition-all duration-300 text-lg">Contact me</button>
          </div>
        </span>
      </header>
      ...
      <main className="flex justify-between items-center px-20 py-16 gap-12">
        <div className="flex flex-grow flex-col items-start">
          ...
          <p className="mt-8 max-w-md text-lg animate-fadeIn text-gray-300 border-l-2 border-gray-400 pl-4">
        ...
        <div className="relative animate-float">
          ...
          <Image src="/avatar.png" alt="Hien The Phan" width={400} height={400} className="rounded-full relative z-10 shadow-lg" />
        </div>
      </main>
      <div className="fixed right-8 top-1/2 transform -translate-y-1/2 flex flex-col gap-6">
        <a href="#discord" className="text-white hover:text-purple-400 transition-all duration-300 transform hover:scale-110"><DiscordIcon /></a>
        <a href="#facebook" className="text-white hover:text-purple-400 transition-all duration-300 transform hover:scale-110"><FacebookIcon /></a>
        <a href="#instagram" className="text-white hover:text-purple-400 transition-all duration-300 transform hover:scale-110"><InstagramIcon /></a>
        <a href="#twitter" className="text-white hover:text-purple-400 transition-all duration-300 transform hover:scale-110"><TwitterIcon /></a>
        <a href="#youtube" className="text-white hover:text-purple-400 transition-all duration-300 transform hover:scale-110"><YoutubeIcon /></a>
        <a href="#send" className="text-white hover:text-purple-400 transition-all duration-300 transform hover:scale-110"><SendIcon /></a>
      </div>
