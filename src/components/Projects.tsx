        ...
        {projects.map((project, index) => (
          ...
          >
            <div className="flex flex-col md:flex-row justify-between items-baseline mb-8">
              <h2 className="text-6xl md:text-8xl font-bold animate-slideInLeft">
                {project.name}
              </h2>
              <p className="text-2xl md:text-3xl text-gray-400 mt-4 md:mt-0">
                {project.date}
              </p>
            </div>
            ...
            <div className="mt-8 flex justify-between items-center">
              <p className="text-xl md:text-2xl text-purple-400 hover:text-purple-300 transition-colors duration-300 cursor-pointer">
                See more projects &gt;&gt;
              </p>
